...
const CrmApi = {
  ...
  respondFeedback:    (id, body, status, draft) => apiFetch(`/feedback/${id}/respond`, { method: 'POST', body: JSON.stringify({ body, status, draft: !!draft }) }),
  getFeedbackDrafts:  () => apiFetch('/feedback/drafts'),
  publishFeedbackDrafts: () => apiFetch('/feedback/publish-drafts', { method: 'POST' }),
